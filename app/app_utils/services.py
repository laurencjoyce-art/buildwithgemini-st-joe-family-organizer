...
# Deployed Engine ID or standalone Memory Bank instance ID
DEFAULT_MEMORY_BANK_ID = "7044104806230654976"
...
def get_memory_service():
    """Process-wide memory service: VertexAiMemoryBankService using Memory Bank."""
    project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-03-bfc93a8a4c23"
    location = (
    ...
    agent_engine_id = (
        os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or DEFAULT_MEMORY_BANK_ID
    )
